...
export const messages = {
  ...
  en: {
    ...
    onboarding: {
      ...
      skipScan: "Skip scan — run it later from the Dashboard",
      continue: "Continue",
      skip: "Skip for now",
      ...
      doneBulletIntegrations: "You can connect GSC/GA4 anytime from the Dashboard",
